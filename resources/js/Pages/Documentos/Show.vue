            ...
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                ...
                >
                    ...
                    <div
                        ...
                        class="p-6 rounded-lg mb-6 border-dashed border-2 border-gray-300 hover:border-gray-500 transition-colors"
                    >
                        <h3 class="text-lg font-medium text-gray-900 mb-4">
                            Archivo Adjunto
                        </h3>
...
export default {
    ...
    methods: {
        ...
        downloadDocument() {
            window.open(
                route("documentos.download", this.documento.id),
                "_blank"
            );
        },
    },
